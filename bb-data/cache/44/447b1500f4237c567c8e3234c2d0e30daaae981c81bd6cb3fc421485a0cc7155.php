...
/* partial_menu.phtml */
class __TwigTemplate_90d61fc03bfa68d15a812a26ca49dd233394a372668df26d94588dee38fc3bae extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "/var/www/boxbilling/bb-themes/admin_default/html/partial_menu.phtml");
    }
}
